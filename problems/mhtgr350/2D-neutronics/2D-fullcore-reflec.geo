// Need to change final dimensions
...
For xindex In {0:num_segments-1}
	...
	bc_refl_surfaces += {416 + xindex*24};
...
For xindex In {0:num_segments-1}
	...
	tc_refl_surfaces += {748 + xindex*24};
...
Physical Curve("outerwall") = {1077, 1074, 1080};
