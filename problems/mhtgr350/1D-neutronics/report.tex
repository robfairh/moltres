...
\subsection{1D-fuel}
	...
	\begin{itemize}
		\item Input file: \textit{1D-fuel.i}
...
\subsection{1D-fuel-eig}
	...
	\begin{itemize}
		\item Input file: \textit{1D-fuel-eig.i}
		\item Mesh: \textit{1D-fuel.msh}
		\item Eigenvalue problem.
	\end{itemize}

Figure \ref{fig:1D-fuel-eig} shows the results. $k_{eff}$ = 1.0875275.
...
\subsection{1D-fuel-reflec}
	...
	\begin{itemize}
		\item Input file: \textit{1D-fuel-reflec.i}
...
Figure \ref{fig:1D-fuel-reflec-eig} shows the results. $k_{eff}$ = 1.124268 and 1.095289.

	\begin{figure}[htbp!]
		\centering
		\begin{subfigure}[t]{0.4\textwidth}
			\centering
			\includegraphics[width=\linewidth]{1D-fuel-reflec-eig1}
