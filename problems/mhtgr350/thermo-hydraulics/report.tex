...
\section{Advection}
	...
	\begin{figure}[htbp!]
		...
		\begin{subfigure}[t]{0.4\textwidth}
			\centering
			\includegraphics[width=\linewidth]{advec4-t-0}
			\caption{t=0.}
		\end{subfigure}
		\begin{subfigure}[t]{0.4\textwidth}
			\centering
			\includegraphics[width=\linewidth]{advec4-t-251}
			\caption{t=250.}
		\end{subfigure}
		\hfill
		\caption{Advected temperature with volumentric source.}
		\label{fig:advec4-t}
	\end{figure}
    ...
    Similar to \textit{advec5-t.i} but has a $q''$ on the wall.
    Figure \ref{fig:advec5-t} shows the results.

	\begin{figure}[htbp!]
		\centering
		\includegraphics[height=5cm]{advec5-t}
