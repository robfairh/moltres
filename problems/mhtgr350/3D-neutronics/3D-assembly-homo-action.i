...
[Nt]
  var_name_base = group
  vacuum_boundaries = 'ref_top ref_bot'
...
[Materials]
  [./fuel]
    ...
    property_tables_root = 'xs800000-500-100/htgr_2g_homoge_'
    interp_type = 'linear'
    block = 'fuel'
  [../]
  [./moderator]
  ...
  [./breflector]
    type = GenericMoltresMaterial
    property_tables_root = 'xs800000-500-100/htgr_2g_brefl_'
    interp_type = 'linear'
    block = 'breflector'
  [../]
  [./treflector]
    type = GenericMoltresMaterial
    property_tables_root = 'xs800000-500-100/htgr_2g_trefl_'
    interp_type = 'linear'
    block = 'treflector'
  [../]
[]
...
[Outputs]
  ...
  [./exodus]
    type = Exodus
    file_base = '3D-assembly-homo-action'
  [../]
[]
